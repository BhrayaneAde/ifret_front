                                  ...
                                  child: ElevatedButton(
                                    onPressed: () async {
                                      if(phoneFormKey.currentState!.validate()){
                                        String phone = '$selectedCountry${_phoneController.text}';
                                        verifyPhone(phone);
                                      }
                                    },
                                    style: ButtonStyle(
    ...
    await FirebaseAuth.instance.verifyPhoneNumber(
      ...
      verificationFailed: (FirebaseAuthException e) {
        ...
        if (e.code == 'invalid-phone-number') {
          ShowToastDialog.showToast("Le numéro renseigné n'est un numéro valide");
        }else{
          ShowToastDialog.showToast("Une erreur s'est produite lors de la vérification du numéro");
        }
      },
  ...
  Future<void> _signInWithPhoneCredential(String verificationId) async {
    try {
      ...
      if(e.code == "invalid-verification-code"){
        ...
        ShowToastDialog.showToast("Le code est déja expiré veuillez faire un renvoie de code");
      }else{
